...
#include "Actors/AI/AIControllerBasicEnemy.h"
#include "GameFramework/Character.h"
#include "Components/StatusComponent.h"
#include "Kismet/KismetSystemLibrary.h"


void AAIControllerBasicEnemy::BeginPlay()
{
	Super::BeginPlay();
...
void AAIControllerBasicEnemy::OnPossess(APawn* InPawn)
{
...
void AAIControllerBasicEnemy::Tick(float DeltaTime)
{
...
void AAIControllerBasicEnemy::OnDamaged(float CurrentHP, float MaxHP)
{
	bDamaged = true;
...
void AAIControllerBasicEnemy::ResetOnDamaged()
{
	bDamaged = false;
}

void AAIControllerBasicEnemy::FindPlayerByPerception()
{
	APawn* OwningPawn = GetPawn();
