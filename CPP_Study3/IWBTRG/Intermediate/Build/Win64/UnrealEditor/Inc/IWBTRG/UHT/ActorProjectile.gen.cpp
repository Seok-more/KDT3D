...
struct Z_Construct_UScriptStruct_FProjectileTableRow_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bOnlyPawn_MetaData[] = {
		{ "Category", "Friendly" },
		{ "ModuleRelativePath", "Actors/ActorProjectile.h" },
	};
#endif // WITH_METADATA
	...
	static void NewProp_bOnlyPawn_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bOnlyPawn;
...
void Z_Construct_UScriptStruct_FProjectileTableRow_Statics::NewProp_bFriendly_SetBit(void* Obj)
{
	((FProjectileTableRow*)Obj)->bFriendly = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FProjectileTableRow_Statics::NewProp_bFriendly = { "bFriendly", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FProjectileTableRow), &Z_Construct_UScriptStruct_FProjectileTableRow_Statics::NewProp_bFriendly_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bFriendly_MetaData), NewProp_bFriendly_MetaData) };
void Z_Construct_UScriptStruct_FProjectileTableRow_Statics::NewProp_bOnlyPawn_SetBit(void* Obj)
{
	((FProjectileTableRow*)Obj)->bOnlyPawn = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FProjectileTableRow_Statics::NewProp_bOnlyPawn = { "bOnlyPawn", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FProjectileTableRow), &Z_Construct_UScriptStruct_FProjectileTableRow_Statics::NewProp_bOnlyPawn_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bOnlyPawn_MetaData), NewProp_bOnlyPawn_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FProjectileTableRow_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FProjectileTableRow_Statics::NewProp_bFriendly,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FProjectileTableRow_Statics::NewProp_bOnlyPawn,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Github_KDT3D_CPP_Study_CPP_Study3_IWBTRG_Source_IWBTRG_Actors_ActorProjectile_h_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Github_KDT3D_CPP_Study_CPP_Study3_IWBTRG_Source_IWBTRG_Actors_ActorProjectile_h_3233608566(TEXT("/Script/IWBTRG"),
	Z_CompiledInDeferFile_FID_Github_KDT3D_CPP_Study_CPP_Study3_IWBTRG_Source_IWBTRG_Actors_ActorProjectile_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Github_KDT3D_CPP_Study_CPP_Study3_IWBTRG_Source_IWBTRG_Actors_ActorProjectile_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Github_KDT3D_CPP_Study_CPP_Study3_IWBTRG_Source_IWBTRG_Actors_ActorProjectile_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Github_KDT3D_CPP_Study_CPP_Study3_IWBTRG_Source_IWBTRG_Actors_ActorProjectile_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
